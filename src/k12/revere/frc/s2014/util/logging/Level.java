...
public class Level {
    ...
    public static final Level OFF       = new Level(Integer.MIN_VALUE,  "OFF");
    ...
    /**
     * Returns -1, 0, or +1 if this Level is lower priority, same priority, or higher priority than the argument,
     * @param other
     * @return 
     */
    public int compareTo(Level other) {
        ...
        //  Compare intValue
        return Math.max(-1, Math.min(1, this.intValue() - other.intValue()));
    }
